...
def signup():
    ...
    return render_template("signup.html", title='Sign Up', form=form, signup_active='active')
...
def account():
    ...
    return render_template("account.html", title='Account', image_file=image_file, account_active='active', form=form)
...
def user_posts(username):
    ...
    return render_template("user_posts.html", posts=posts, user=user, mposts_active='active')
